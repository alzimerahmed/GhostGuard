# GhostGuard Architecture

The `GhostGuard` app uses a hybrid architecture: high-performance network filtering is handled by Go, while the UI, persistence, and Android system integration are handled by Kotlin.
