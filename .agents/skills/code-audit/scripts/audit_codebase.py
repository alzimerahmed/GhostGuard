...
APP_DIR = ROOT_DIR / "app" / "src" / "main" / "java" / "app" / "ghostguard"
...
def check_line_counts():
    violations = []
    targets = [ROOT_DIR / "app", ROOT_DIR / "tunnel"]
    extensions = {".kt", ".go"}
...
def check_verbose_comments():
    issues = []
    targets = [ROOT_DIR / "app" / "src" / "main" / "java"]
...
def main():
    print("# GhostGuard Codebase Audit Report\n")
