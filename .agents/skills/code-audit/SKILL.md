...
This skill diagnoses code smells, architectural violations, and rule non-compliance across the `GhostGuard` project, then guides safe, incremental refactoring according to project standards (`GEMINI.md` and `.agent/rules/`).
