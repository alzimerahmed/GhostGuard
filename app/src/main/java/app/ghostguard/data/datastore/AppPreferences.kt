package app.ghostguard.data.datastore

import android.content.Context
import androidx.datastore.core.DataStore
import androidx.datastore.preferences.core.Preferences
import androidx.datastore.preferences.preferencesDataStore
import app.ghostguard.data.datastore.prefs.AppearancePreferences
import app.ghostguard.data.datastore.prefs.DnsPreferences
import app.ghostguard.data.datastore.prefs.FilterPreferences
import app.ghostguard.data.datastore.prefs.VpnSecurityPreferences
import app.ghostguard.data.datastore.prefs.WireGuardPreferences
import app.ghostguard.data.entities.DnsProtocol
import app.ghostguard.data.entities.WireGuardProfile
