...
class ProfileManager(
     ...
     */
    suspend fun saveActiveProfileFilterUrls() =
        withContext(Dispatchers.IO) {
     ...
     */
    suspend fun switchToProfile(profileId: Long) =
        withContext(Dispatchers.IO) {
            ...
            val targetUrls =
                if (targetProfile.enabledFilterUrls.isBlank() && ProtectionProfile.isPreset(targetProfile.profileType)) {
     ...
     */
    fun getFilterUrlsForType(type: String): Set<String> =
        when (type) {
