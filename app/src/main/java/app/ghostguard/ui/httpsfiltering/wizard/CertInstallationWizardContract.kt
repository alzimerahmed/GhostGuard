...
enum class WizardStep(
    ...
    INSTALL_CA(3, app.ghostguard.R.string.https_filtering_step2_title),
    VERIFY(4, app.ghostguard.R.string.https_filtering_step3_title),
}
...
data class CertInstallationWizardUiState(
    ...
    val fileName: String = "GhostGuard-RootCA.crt",
