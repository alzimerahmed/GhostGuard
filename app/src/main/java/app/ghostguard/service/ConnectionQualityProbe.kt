...
class ConnectionQualityProbe(
    ...
    companion object {
        ...
        // Local fake DNS IP of GhostGuard TUN (RFC 6598 CGNAT)
     ...
     */
    suspend fun probePhysicalInternet(): Boolean =
     ...
     */
    suspend fun probeVpnDns(): Boolean =
        withContext(Dispatchers.IO) {
     ...
     */
    suspend fun runDiagnosis(): ProbeResult =
        withContext(Dispatchers.IO) {
