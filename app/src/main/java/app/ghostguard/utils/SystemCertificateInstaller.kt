...
/**
 * Utility to install GhostGuard Root CA directly into the Android System CA Store
    ...
    fun installToSystemStore(caPem: String): Result<String> {
        ...
        return try {
            ...
            val moduleProp =
                """
                id=$MODULE_ID
                name=GhostGuard Root CA
                version=1.1
                versionCode=2
                author=GhostGuard
                description=System CA Certificate for GhostGuard HTTPS Filtering
                """.trimIndent()
